        ...
        <div class="col-12">
            <div class="card recent-sales overflow-auto">
                <div class="card-body">
                    ...
                    <a href="{{ route('konselor-tambah-komunitas') }}" class="btn btn-sm btn-success">Tambah
                        Komunitas</a>
                </div>
            </div>
        </div>
                ...
                <div class="card card-komunitas">
                    <div class="row g-0">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-start">
                                    <a href="{{ route('konselor-read-komunitas', ['id_komunitas' => $item->id]) }}">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <li><a class="dropdown-item"
                                                    href="{{ route('konselor-edit-komunitas', ['id_komunitas' => $item->id]) }}">Ubah
                                                    Komunitas</a></li>
                                        </ul>
                                    </div>
                                </div>
    ...
    <script>
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('konselor-delete-komunitas') }}",
                        type: 'POST',
                        data: {
                            id: id,
                        },
