        ...
        <table class="table table-borderless datatable">
          ...
          <tbody>
            ...
            <tr>
                ...
                <td>{{$value->email}}</td>                 
                <td>
                  @if ($value->is_role == 'Admin')
                      <span class="btn btn-success btn-sm">{{ $value->is_role }}</span> <!-- Merah untuk Admin -->
                  @elseif ($value->is_role == 'Konselor')
                      <span class="btn btn-warning btn-sm">{{ $value->is_role }}</span> <!-- Kuning untuk Konselor -->
                  @elseif ($value->is_role == 'Mahasiswa')
                      <span class="btn btn-primary btn-sm">{{ $value->is_role }}</span> <!-- Hijau untuk Mahasiswa -->
                  @endif
              </td>
          ...
          <form id="createForm" >
                ...
                <div class="col-12">
                  <label for="yourUsername" class="form-label">Status</label>
                    <div class="input-group has-validation">
                      <Select required class="form-control" id="is_role">
        ...
        <div class="modal-body">
          <form id="editForm">        
                ...
                <div class="col-12">
                  <label for="yourUsername" class="form-label">Status</label>
                    <div class="input-group has-validation">
                      <Select required class="form-control" id="edit_is_role">
                        <option value="" style="text-align: center" selected disabled>-- Silahkan Pilih Status --</option>
                          <option value="Admin">Admin</option>
                          <option value="Konselor">Konselor</option>
                          <option value="Mahasiswa">Mahasiswa</option>
  ...
  <script>
    $(document).ready(function() {
        $("#createForm").submit(function(event) {
            ...
            formData.append("is_role", $("#is_role").val());          
            $.ajax({
        ...
        $("#editForm").submit(function(event) {
            ...
            formData.append("is_role", $("#edit_is_role").val());          
