...
@section('content_admin')
        ...
        <div class="col-12">
            <div class="card recent-sales overflow-auto">
                <div class="card-body">
                    ...
                    <a href="{{ route('admin-komunitas') }}" class="btn btn-sm btn-success"> <i
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <input type="text" name="nama_komunitas" id="nama_komunitas" class="form-control"
                                placeholder="Masukkan nama komunitas...." value="{{ $komunitas->nama_komunitas }}">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <input type="text" name="kategori" id="kategori" class="form-control"
                                placeholder="Masukkan kategori" value="{{ $komunitas->kategori_komunitas }}">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <input type="text" name="deskripsi" id="deskripsi" class="form-control"
                                placeholder="Masukkan deskripsi..." value="{{ $komunitas->deskripsi }}">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="">Tulisan</label>
                            <textarea name="artikel" id="artikel" cols="30" rows="5" class="form-control">{{ $komunitas->artikel }}</textarea>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="Gambar">Update Gambar</label><br>
                            @if ($komunitas->img_path)
                                <img src="{{ asset('storage/' . $komunitas->img_path) }}"
                                    class="img-fluid rounded-start mb-3" alt="Alt {{ $komunitas->nama_komunitas }}"
                                    width="300px"><br>
                            @else
    ...
    <script>
        function storeKomunitas() {
            ...
            formData.append('id', $('#id_komunitas').val());
            ...
            $.ajax({
                url: "{{ route('admin-save-komunitas') }}",
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
                ...
                success: function(response) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            window.location.href = "{{ route('admin-komunitas') }}";
                        }
                    });
                },
                error: function(xhr) {
